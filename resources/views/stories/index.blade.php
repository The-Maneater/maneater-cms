    ...
    <div class="columns">
        <div class="column is-8">
            ...
            <div class="is-flex justify-center">
                <div class="main-photo-wrapper {{ count($frontPageStories[1]->headerPhotos) == 0 ? "main-photo-wrapper-fixer" : "" }}">
            ...
            <div class="columns">
                <div class="column is-6 flex-column align-center">
                    <div class="story-grid-block">
                        @if(count($frontPageStories[2]->headerPhotos) > 0)
                            <img src="{{ $frontPageStories[2]->headerPhotos[0]->path() }}" alt="">
                        @endif
                        <h2 class="m-t-10-b-10"><a class="is-black" href="{{ $frontPageStories[2]->path() }}">{{ $frontPageStories[2]->title }}</a></h2>
                    ...
                    <div class="story-grid-block">
                        ...
                        @endif
                        <h2 class="m-t-10-b-10"><a class="is-black" href="{{ $frontPageStories[4]->path() }}">{{ $frontPageStories[4]->title }}</a></h2>
                ...
                <div class="column is-6 flex-column align-center">
                    <div class="story-grid-block">
                        @if(count($frontPageStories[3]->headerPhotos) > 0)
                            <img src="{{ $frontPageStories[3]->headerPhotos[0]->path() }}" alt="">
                        @endif
                        <h2 class="m-t-10-b-10"><a class="is-black" href="{{ $frontPageStories[3]->path() }}">{{ $frontPageStories[3]->title }}</a></h2>
            ...
            <div class="columns m-l-25">
                <div class="column is-4 b-right news-section">
                    <h1 class="all-caps">SPORTS</h1>
                        ...
                        @for($i = 0; $i<5; $i++)
                            <li>
                                @if($i == 0 && count($sections['sports'][$i]->headerPhotos) > 0 )
                                 ...
                                 @elseif($i == 0 && count($sections['sports'][$i]->graphics) > 0 )
                                    <img class="front-page-image" src="{{ $sections['sports'][$i]->graphics[0]->linkPath() }}" alt="">
                                @endif
                                <a href="{{ $sections['sports'][$i]->path() }}" class="is-info is-black">{{ $sections['sports'][$i]->title }}</a>
                            </li>
                        @endfor
                    </ul>
                </div>
                <div class="column is-4 b-right news-section">
                    <h1 class="all-caps">NEWS</h1>
                    <ul class="sectionlist sectionlist-short">
                        @for($i = 0; $i<5; $i++)
                            <li>
                                @if($i == 0 && count($sections['news'][$i]->headerPhotos) > 0 )
                                    <img class="front-page-image" src="{{ $sections['news'][$i]->headerPhotos[0]->path() }}" alt="">
                                @elseif($i == 0 && count($sections['news'][$i]->graphics) > 0 )
                                    <img class="front-page-image" src="{{ $sections['news'][$i]->graphics[0]->linkPath() }}" alt="">
                                @endif
                                <a href="{{ $sections['news'][$i]->path() }}" class="is-info is-black">{{ $sections['news'][$i]->title }}</a>
                            </li>
                        @endfor
                    </ul>
                </div>
                <div class="column is-4 news-section">
                    <h1 class="all-caps">OPINION</h1>
                    <ul class="sectionlist sectionlist-short">
                        @for($i = 0; $i<5; $i++)
                            <li>
                                ...
                                @endif
                                <a href="{{ $sections['opinion'][$i]->path() }}" class="is-info is-black">{{ $sections['opinion'][$i]->title }}</a>
                            </li>
                        @endfor
                    </ul>
                </div>
            ...
            <hr>
            <div>
                <h1 class="all-caps">From Move Magazine:</h1>
                <div class="columns">
                    <div class="column is-3">
                        <a class="is-black move-red-hover d-inline-block center-text" href="{{ config("app.move_url") }}/section/around-como">
                            <i class="fas fa-building move-icon"></i>
                            <br>
                            Around Town
                        </a>
                    </div>
                    <div class="column is-3">
                        <a class="is-black move-red-hover d-inline-block center-text" href="{{ config("app.move_url") }}/section/on-campus">
                            <i class="fas fa-university move-icon"></i>
                            <br>
                            On Campus
                        </a>
                    </div>
                    <div class="column is-3">
                        <a class="is-black move-red-hover d-inline-block center-text" href="{{ config("app.move_url") }}/section/movies">
                            <i class="fas fa-film move-icon"></i>
                            <br>
                            Movies
                        </a>
                    </div>
                    <div class="column is-3">
                        <a class="is-black move-red-hover d-inline-block center-text" href="{{ config("app.move_url") }}/section/music">
                            <i class="fas fa-music move-icon"></i>
                            <br>
                            Music
                        </a>
                    </div>
        ...
        <div class="column is-4 right-section">
            <h3 class="header-divider is-bold"><a class="is-black" href="/stories/">LATEST</a></h3>
