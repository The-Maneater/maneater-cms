                                    ...
                                    <div class="carousel-item active">
                                        <div class="crop-carousel-photos">
                                            @if(count($frontPageStories[1]->headerPhotos) > 0)
                                                <img class="d-block lazy" src="http://themaneater.com/media/2018/917/photos/1x1_placeholder.png" data-orig="{{ $frontPageStories[1]->headerPhotos[0]->path() }}" alt="First slide">

                                            @elseif(count($frontPageStories[1]->graphics) > 0 )
                                                <img class="d-block lazy" src="http://themaneater.com/media/2018/917/photos/1x1_placeholder.png" data-orig="{{ $frontPageStories[1]->graphics[0]->linkPath() }}" alt="First slide">
                                            @endif
                                        </div>
                                    ...
                                    <div class="carousel-item">
                                        <div class="crop-carousel-photos">
                                            @if(count($frontPageStories[2]->headerPhotos) > 0)
                                                <img class="d-block lazy" src="http://themaneater.com/media/2018/917/photos/1x1_placeholder.png" data-orig="{{ $frontPageStories[2]->headerPhotos[0]->path() }}" alt="Second slide">
                                            @elseif(count($frontPageStories[2]->graphics) > 0 )
                                                <img class="d-block lazy" src="http://themaneater.com/media/2018/917/photos/1x1_placeholder.png" data-orig="{{ $frontPageStories[2]->graphics[0]->linkPath() }}" alt="Second slide">
                                            @endif
                                        </div>
                                        <div class="justify-text carousel-sm-item">
                                    ...
                                    <div class="carousel-item">
                                        <div class="crop-carousel-photos">
                                            @if(count($frontPageStories[3]->headerPhotos) > 0)
                                                <img class="d-block lazy" src="http://themaneater.com/media/2018/917/photos/1x1_placeholder.png" data-orig="{{ $frontPageStories[3]->headerPhotos[0]->path() }}" alt="Third slide">
                                            @elseif(count($frontPageStories[3]->graphics) > 0 )
                                                <img class="d-block lazy" src="http://themaneater.com/media/2018/917/photos/1x1_placeholder.png" data-orig="{{ $frontPageStories[3]->graphics[0]->linkPath() }}" alt="Third slide">
                                            @endif
                                        </div>
                                        <div class="justify-text carousel-sm-item">
                        ...
                        <a href="{{ $sections['news'][$i]->path() }}">
                            <li class="media border-bottom mr-md-3 ml-md-0 ml-2 pr-2">
                                ...
                                @elseif(count($sections['news'][$i]->graphics) > 0 )
                                    <img clas="mr-3 lazy" src="http://themaneater.com/media/2018/917/photos/1x1_placeholder.png" data-orig="{{ $sections['news'][$i]->graphics[0]->linkPath() }}" alt="">
                                @endif
                                </figure>
                        ...
                        <a href="{{ $sections['sports'][$i]->path() }}">
                            <li class="media mb-md-3 border-bottom pr-md-0 mr-md-5 ml-2 pr-2">
                                ...
                                @elseif(count($sections['sports'][$i]->graphics) > 0 )
                                    <img clas="mr-3 lazy" src="http://themaneater.com/media/2018/917/photos/1x1_placeholder.png" data-orig="{{ $sections['sports'][$i]->graphics[0]->linkPath() }}" alt="">
                                @endif
                                </figure>
                            </li>
                        </a>
                ...
                <div class="col-md-7 mx-0 px-0">
                    ...
                    <ul class="list-unstyled pl-md-3 pt-md-3 mt-md-5">
                        ...
                        <a href="{{ $sections['opinion'][$i]->path() }}">
                            <li class="media mb-md-3 border-bottom mr-3 ml-2 pr-2">
                                <figure class="crop-section-photos mr-3 mt-2">
                                ...
                                @elseif(count($sections['opinion'][$i]->graphics) > 0 )
                                    <img clas="mr-3 lazy" src="http://themaneater.com/media/2018/917/photos/1x1_placeholder.png" data-orig="{{ $sections['opinion'][$i]->graphics[0]->linkPath() }}" alt="">
                                @endif
                                </figure>
                                <div class="media-body">
