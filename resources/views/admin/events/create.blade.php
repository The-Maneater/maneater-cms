        ...
        <form action="{{ route('create-event') }}" method="POST" id="storyForm">
            ...
            <div class="field-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="start_date" id="start_date" class="wideTextField form-control" value="2016-08-22 12:00:00">
                </div>
                <div class="form-group">
                    <label for="end_date">End Date:</label>
                    <input type="text" name="end_date" id="end_date" class="wideTextField form-control" value="2016-08-22 14:00:00">
                </div>
                <div class="form-group">
